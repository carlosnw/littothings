...
get_header(); ?>
		...
		<main class="site-content content-404" itemscope="itemscope" itemprop="mainContentOfPage"><!-- Main content -->
			...
			<div class="page-content">
				<p class="info-404"><?php esc_html_e( 'Oops! Seems like the page you are looking for doesn\'t exisit, try searching below or return to' , 'brideliness' ); ?>
					<a href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e('Homepage', 'brideliness');?></a>
				</p>
			</div>
			<?php get_search_form(); ?>
