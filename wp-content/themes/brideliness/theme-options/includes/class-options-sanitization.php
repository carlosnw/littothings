...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'brideliness' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'brideliness' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'brideliness' ),
		'repeat'    => esc_html__( 'Repeat All', 'brideliness' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'brideliness' ),
		'top center'    => esc_html__( 'Top Center', 'brideliness' ),
		'top right'     => esc_html__( 'Top Right', 'brideliness' ),
		'center left'   => esc_html__( 'Middle Left', 'brideliness' ),
		'center center' => esc_html__( 'Middle Center', 'brideliness' ),
		'center right'  => esc_html__( 'Middle Right', 'brideliness' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'brideliness' ),
		'bottom center' => esc_html__( 'Bottom Center', 'brideliness' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'brideliness')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'brideliness' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'brideliness')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'brideliness' ),
		'italic'      => esc_html__( 'Italic', 'brideliness' ),
		'bold'        => esc_html__( 'Bold', 'brideliness' ),
		'lighter'     => esc_html__( 'Light', 'brideliness' ),
		'bold italic' => esc_html__( 'Bold Italic', 'brideliness' )
		);
