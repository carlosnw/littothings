...
class __TwigTemplate_b7ec174fc01df08e01f468c96a7b25b869bbfa68e6f9132dd3f3fbe5079bffcb extends Twig_Template
{
...
<input type=\"text\" disabled=\"disabled\" value=\"\" placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" />";
    ...
    {
        return new Twig_Source("", "form/templates/blocks/text.hbs", "/app/public/wp-content/plugins/mailpoet/views/form/templates/blocks/text.hbs");
    }
}
